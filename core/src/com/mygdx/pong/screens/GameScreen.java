...
public class GameScreen implements Screen {
    ...
    private void setInputProcessor(int screenWidth, int screenHeight) {
        Gdx.input.setInputProcessor(new InputHandler(world, world.getPaddle1(), screenWidth, screenHeight));
    }
